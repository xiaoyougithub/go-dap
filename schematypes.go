...
var eventCtor = map[string]messageCtor{
	...
	"stoppedData":        func() Message { return &StoppedDataEvent{} },
	"setBreakpointsList": func() Message { return &SetBreakpointsListEvent{} },
}
